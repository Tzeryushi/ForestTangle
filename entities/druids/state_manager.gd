...
@export var first_state : DruidState
@export var animation : AnimatedSprite2D

var current_state : DruidState

func swap_state(new_state:DruidState) -> void:
